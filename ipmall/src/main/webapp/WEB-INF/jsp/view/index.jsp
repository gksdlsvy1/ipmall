	...
	<div class="header-bg">
		<div class="container">
			<div class="row">
				...
				<!--  <input type="button" class="btn btn-default"><a href="search.do">Find</a> -->
				<!--   <button type="Find" class="btn btn-default"><a href="search.do">Find</a></button> -->
					...
					<div class="modal-dialog modal-md">
						<div class="modal-content light-box-info">
							...
							<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
								...
								est hendrerit, eget sodales lectus tincidunt. Etiam suscipit
								orci sapien, at molestie lorem imperdiet vitae. Fusce nunc eros,
